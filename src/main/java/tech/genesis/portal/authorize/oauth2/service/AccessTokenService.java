...
public class AccessTokenService {
     ...
     * @throws Exception
     */
    public BearerTokenResponse getAccessToken(HttpSession session, String userName, String password) throws Exception {
        
    	HttpPost post = new HttpPost(oAuth2Configuration.getTokenEndpoint());

        logger.info("getUrlParameter : "+ userName +":"+ password);
        
        // add header
        post = httpHelper.addHeader(post);
        List<NameValuePair> urlParameters = httpHelper.getUrlParameters(session, "password", userName, password);
    ...
    public BearerTokenResponse getAccessTokenPassword(String userName, String password) throws Exception {
        ...
        // add header
        post = httpHelper.addHeader(post);
        List<NameValuePair> urlParameters = httpHelper.getUrlParametersPassword(userName, password);
