...
public class OrganizationPk implements Serializable {
    ...
    private static final long serialVersionUID = 476151177562655458L;
	...
	public OrganizationPk(String uuid, String tenentId) {
		this.uuid = uuid;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OrganizationPk other = (OrganizationPk) obj;
		if (tenentId == null) {
